...
- Added Ironwood value pool entries to `getblock` and `getblockchaininfo`
  output.

### Changed

- `getblocktemplate` uses the NU6.3 Ironwood coinbase reward path for
  Orchard-only unified miner addresses.
