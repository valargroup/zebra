...
impl MinerParams {
    ...
    /// that can be used for coinbase rewards after NU7.
...
pub enum MinerParamsError {
    ...
    OversizedData,
    #[error(
        "Miner address cannot receive coinbase rewards after NU7 because unified addresses must include a Sapling or transparent receiver"
    )]
