...
proptest! {
    ...
    /// [`ValueBalance::to_bytes`] produces the new 48-byte layout with the
    /// legacy bytes intact in the first 32.
    #[test]
    ...
    /// to zero on parse; round-tripping back produces the new 48-byte layout
    /// with the legacy bytes intact in the first 40.
    #[test]
