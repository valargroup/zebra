...
fn full_activation_list_contains_all_upgrades() {
    ...
    // NU6.3 and NU7 are unscheduled on Mainnet (no activation height committed), so they are absent
    // from the full activation list even though they are always present in the iter.
