...
- `network.v2_p2p = "default"` now follows the selected network: `false` on
  Mainnet, and `true` on Testnet, Regtest, and other networks. Set
  `network.v2_p2p = true` or `false` to override that network default.
