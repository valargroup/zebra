...
/// 600 blocks. (1 fork per 120 blocks.) When block propagation is efficient, there is around
/// 1 fork per 600 blocks.
///
...
/// `100 entries * up to 600 blocks * 2 MB per block = 120 GB`
