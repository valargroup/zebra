...
use crate::service::finalized_state::{
    disk_format::shielded::CommitmentRootsByHeight, ZebraDb, COMMITMENT_ROOTS_BY_HEIGHT,
};
...
pub(crate) fn dump_store(state: &ZebraDb) -> StoreDump {
...
pub(crate) fn audit_store(state: &ZebraDb) -> Vec<Violation> {
