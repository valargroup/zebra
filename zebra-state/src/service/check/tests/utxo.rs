...
proptest! {
    ...
    fn accept_later_transparent_spend_from_this_block(
        ...
        if use_finalized_state {
            ...
            let commit_result = finalized_state.commit_finalized_direct(block1.clone().into(), None, None, None, "test", None, None);
    ...
    fn accept_arbitrary_transparent_spend_from_previous_block(
        ...
        if use_finalized_state_spend {
            ...
            let commit_result = finalized_state.commit_finalized_direct(block2.clone().into(), None, None, None, "test", None, None);
