...
use crate::{
    ...
    service::{
        ...
        chain_tip::TipAction,
        finalized_state::{DiskWriteBatch, WriteDisk, ZebraDb, STATE_COLUMN_FAMILIES_IN_CODE},
...
fn new_ephemeral_db(network: &Network) -> ZebraDb {
    ZebraDb::new(
        &Config::ephemeral(),
        STATE_DATABASE_KIND,
...
fn insert_zakura_header(state: &ZebraDb, height: Height, header: Arc<block::Header>) {
