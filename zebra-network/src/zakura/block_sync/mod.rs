...
//!
//! New to this subsystem? Start in [`peer_routine`] — it is the "start here" map
//! of how a peer's stream-6 frames flow through the per-peer routine, the work
//! queue, the commit pipeline, the registry, and the reactor.
