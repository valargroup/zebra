...
/// Default depth for block-sync action/body channels.
///
...
/// maximum checkpoint gap plus the boundary block in flight, so the default
/// channel depth preserves that legacy minimum.
