...

{
  ...
  echo "| First RPC response seconds | ${FIRST_RPC_SECONDS:-n/a} |"
  echo "| First non-zero RPC height seconds | ${FIRST_BLOCK_SECONDS:-n/a} |"
  echo "| First non-zero RPC height | ${FIRST_BLOCK_HEIGHT:-n/a} |"
